...
CREATE TABLE `account_balances` (
  ...
  `available_value_cents` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_account_balances_on_user_id` (`user_id`),
  CONSTRAINT `fk_rails_30b52bf707` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `account_balances` VALUES (1,1,1000000,'2021-02-11 18:38:45','2021-02-11 18:38:45');
