...
ActiveRecord::Schema.define(version: 20210216172616) do
  ...
  create_table "account_balances", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_account_balances_on_user_id", using: :btree
  end

  create_table "account_extracts", force: :cascade do |t|
    t.integer  "user_id"
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["account_balance_id"], name: "index_account_extracts_on_account_balance_id", using: :btree
    t.index ["user_id"], name: "index_account_extracts_on_user_id", using: :btree
  end
  ...
  create_table "bank_transactions", force: :cascade do |t|
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.index ["user_id"], name: "index_bank_transactions_on_user_id", using: :btree
  end
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.index ["state_id"], name: "index_members_on_state_id", using: :btree
  end

  create_table "nobe_revenues", force: :cascade do |t|
    t.integer  "user_id"
    t.string   "description"
    t.integer  "value_cents"
    t.datetime "created_at",          null: false
    ...
    t.index ["bank_transaction_id"], name: "index_nobe_revenues_on_bank_transaction_id", using: :btree
    t.index ["user_id"], name: "index_nobe_revenues_on_user_id", using: :btree
  end
  ...
  create_table "outgoings", force: :cascade do |t|
    ...
    t.datetime "updated_at",   null: false
    t.integer  "reference_id"
    t.index ["user_id"], name: "index_outgoings_on_user_id", using: :btree
  end

  create_table "pagseguro_histories", force: :cascade do |t|
    t.integer  "recharge_id"
    t.integer  "status"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["recharge_id"], name: "index_pagseguro_histories_on_recharge_id", using: :btree
  end
  ...
  create_table "recharges", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                     null: false
    t.datetime "updated_at",                                                     null: false
    t.index ["user_id"], name: "index_recharges_on_user_id", using: :btree
  end
